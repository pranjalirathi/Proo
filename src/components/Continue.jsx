          ...
          <div className="space-y-4">
            <div>
              <p className="text-xs text-gray-400">
                Wanna change the password cause you may be it's that tough that you might forget the old one, right? It's fine, We gotcha!
              </p>
              <div className="flex space-x-2 mt-2">
                <button
                  className="bg-blue-600 hover:bg-blue-800 px-4 py-2 rounded text-sm"
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                Deleting the account will permanently delete all of your data and you won't be able to recover it later.
              </p>
              <div className="flex space-x-2 mt-2">
                <button
                  className="bg-red-600 px-4 py-2 rounded text-sm hover:bg-red-800"
